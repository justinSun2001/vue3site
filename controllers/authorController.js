...
exports.author_detail = function (req, res, next) {
    ...
    async.parallel({
        ...
        authors_articles: function (callback) {
            Article.find({ 'author': req.params.id }, 'title summary')
                .exec(callback)
        },
        ...
        // Successful, so render.
        res.render('author_detail', { title: 'Author Detail', author: results.author, author_articles: results.authors_articles });
    });
...
exports.author_delete_post = function (req, res, next) {
    ...
    async.parallel({
        ...
        if (results.authors_articles.length > 0) {
            ...
            // Author has no s. Delete object and redirect to the list of authors.
